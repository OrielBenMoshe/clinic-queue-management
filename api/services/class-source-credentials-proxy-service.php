...
/**
 * Source Credentials Proxy Service – פניות ל-Proxy API (SourceCredentials/Save)
 */
class Clinic_Queue_Source_Credentials_Proxy_Service extends Clinic_Queue_Base_Proxy_Service {
