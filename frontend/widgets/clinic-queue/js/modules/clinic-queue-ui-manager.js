    ...
    class UIManager {
        ...
        async handleSchedulerChange(schedulerId) {
            if (!schedulerId || !this.core.effectiveClinicId) {
                window.ClinicQueueUtils.log('No scheduler or clinic selected');
            ...
            try {
                ...
                window.ClinicQueueUtils.error('Failed to handle scheduler change:', error);
                this.disableTreatmentField();
        ...
        enableTreatmentField() {
            ...
            window.ClinicQueueUtils.log('Treatment field enabled');
        }
        ...
        disableTreatmentField() {
            ...
            window.ClinicQueueUtils.log('Treatment field disabled');
        }
