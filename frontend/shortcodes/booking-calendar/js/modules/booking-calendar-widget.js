...
(function($) {
    ...
    // Main BookingCalendarWidget class
    class BookingCalendarWidget {
        constructor(element) {
        ...
        init() {
            console.log('[BookingCalendar] Widget initialized with ID:', this.widgetId);
            console.log('[BookingCalendar] Initial configuration:', {
        ...
        bindEvents() {
            ...
            this.element.on(`change${eventNamespace}`, '.form-field-select', (e) => {
                ...
                window.BookingCalendarUtils.log('Form field changed:', { field, value });
            ...
            this.element.on(`click${eventNamespace}`, '.day-tab:not(.disabled)', (e) => {
                ...
                console.log('[BookingCalendar] Day tab clicked:', date, $target.attr('class'));
                console.log('[BookingCalendar] Target element:', $target);
                if (date) {
        ...
        async handleFormFieldChange(field, value) {
            console.log(`[BookingCalendar] Field changed: ${field} = ${value}`);
        ...
        getWidgetSettings() {
            ...
            console.log('[BookingCalendar] Widget settings:', settings);
            return settings;
        }
        ...
        handleFormSubmit() {
            window.BookingCalendarUtils.log('Form submitted');
            const form = this.element.find('.widget-selection-form');
            const formData = this.getFormData(form);
        ...
        viewAllAppointments() {
            ...
            console.log('[BookingCalendar] View all appointments clicked - action disabled');
        }
    ...
    window.BookingCalendarWidget = BookingCalendarWidget;
